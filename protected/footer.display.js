...
(function () {
  ...
  // Backward-compatible: some pages use this original id (e.g., index.html)
  const legacyFooterBalanceElementId = "footer-balance-display";
  ...
  function updateNavBalanceDisplay() {
    ...
    const navBalanceEl = document.getElementById(navBalanceElementId) || document.getElementById(legacyFooterBalanceElementId);
